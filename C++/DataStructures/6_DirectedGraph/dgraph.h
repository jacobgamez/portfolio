...
class dgraph
{
 ...
 public:
  ...
  void visit(int,char);  //assigns a visit number to the vertex name provided.
  
  bool isMarked(char); //checks if a vertex is marked and if it is, provides the name of said vertex to the user.
};
